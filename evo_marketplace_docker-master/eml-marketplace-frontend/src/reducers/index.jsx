...
import UserBadgesReducer from './users/user_badges';
...
import OptedFreelancersReducer from './opted_freelancers';
...
import getClientRatingReducer from './get_client_ratings';
import getFreelancerRatingReducer from './get_freelancer_ratings';
import ChatroomReducer from './chatroom';
import HomeCategoryReducer from './home_categories';
import HomeIllustrationReducer from './home_illustrations';
import lastJobReducer from './last_jobs';
...
export default combineReducers({
  ...
  opted_freelancers_reducer: OptedFreelancersReducer,
  ...
  user_badges_reducer: UserBadgesReducer,
  ...
  get_freelancer_ratings_reducer: getFreelancerRatingReducer,
  get_client_ratings_reducer: getClientRatingReducer,
  home_categories_reducer: HomeCategoryReducer,
  home_illustrations_reducer: HomeIllustrationReducer,
  lastJobReducer: lastJobReducer,
});
