...
import emailConfirmationBanner from './../../../images/passreset.png';
...
class NewPassword extends Component {
  ...
  render(){
    ...
    return (
      <div className="forgot-password-holder password-reset">
          ...
          <Form onSubmit={this.handleSubmit} className="forgot-password-form">
            <FormItem>
              {getFieldDecorator('email', {
                rules: [{ required: true, message: 'Your email' }, {max: 100, message: 'Please enter valid email address'}],
              })(
