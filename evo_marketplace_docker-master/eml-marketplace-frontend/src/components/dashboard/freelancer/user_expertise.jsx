   ...
   return (
      <React.Fragment>
            {user_badges && user_badges.length > 0 ?
              <div className="home-sidebar-block badges-block">
                <h2>Your Badges</h2>
                    ...
                    <React.Fragment key={index}>
                        <li>
                          ...
                          <div className="skill-content">
                            <strong>{val.title} <Tooltip className="help-link" title={val.description}><Icon type="question-circle-o" style={{ color:'#bfbfbf', fontSize:'14px', fontWeight:'400'}} /></Tooltip></strong>
...
export default connect(mapStateToProps, mapDispatchToProps)(UserExpertise);