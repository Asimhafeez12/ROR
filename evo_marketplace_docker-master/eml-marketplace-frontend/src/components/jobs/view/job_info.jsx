      ...
      <div className="job-info-holder">
        ...
        <div className="job-info-top">
          <ul>
            <li>
              <h3>Total Budget</h3>
              <span>${(job.amount_remaining_for_open_milestones/100) + (job.amount_paid_for_completed_milestones/100) }</span>
            </li>
            <li>
              <h3>In Escrow</h3>
        ...
        <div className="job-info-bottom">
          ...
          <ul>
            ...
            <li>
              <h3>Hired on</h3>
              <span>{moment(job.first_freelancer_hired_on).format('MM/DD/YYYY')}</span>
            </li>
            <li>
              <h3>Closed on</h3>
