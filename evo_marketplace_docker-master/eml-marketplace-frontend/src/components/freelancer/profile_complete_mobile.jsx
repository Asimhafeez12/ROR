...
class ProfileCompleteMobile extends Component {
	...
	render() {
		...
		return (
			<React.Fragment>
				<div className="block-white profile-completion-block">
...
export default connect(mapStateToProps, mapDispatchToProps)(ProfileCompleteMobile);
