          ...
          <Form onSubmit={this.handleSubmit}>
            <div className="freelancer-signup-form-row">
              <FormItem label="Skype Id">
                ...
                rules: [{ required: true, message: 'Please Enter your Skype id' }, {max: 50, message: 'Please enter valid skype id'}],
                })(<Input size="large" />
                )}
              </FormItem>
            </div>
            <div className="freelancer-signup-form-row">
              <FormItem label="Phone Number">
                ...
                rules: [{ required: true, message: 'Please Enter your Phone Number' }, {message: 'Please input numbers' }, {max: 50, message: 'Please enter valid phone number'}],
            ...
            <div className="freelancer-signup-form-row">
              <FormItem label="Choose your date of availability">
                ...
                })(<DatePicker size="large" disabledDate={this.disabledDate} placeholder="Choose Date" style={{ width:"100%" }} />)}
              </FormItem>
            </div>
            <div className="freelancer-signup-form-row">
