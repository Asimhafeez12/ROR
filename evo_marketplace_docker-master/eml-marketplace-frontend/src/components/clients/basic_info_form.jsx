            ...
            <Form key={1} className="job-post-form" onSubmit={this.handleSubmit.bind(this)}>
              <FormItem className="popup-form-title">
                {getFieldDecorator('first_name', {
                  ...
                  rules: [{ required: true, message: 'Please enter your first name' }, {max: 100, message: 'Please enter less text for first name'}],
              ...
              <FormItem className="popup-form-title">
                  {getFieldDecorator('last_name',{
                    ...
                    rules: [{ required: true, message: 'Please enter your last name' }, {max: 100, message: 'Please enter less text for last name'}],
                  })(
              ...
              <FormItem className="popup-form-title">
                  {getFieldDecorator('title',{
                    ...
                    rules: [{ required: true, message: 'Please enter your title' }, {max: 100, message: 'Please enter less text for title'}],
                  })(
              ...
              <FormItem className="popup-form-title">
                  {getFieldDecorator('city',{
                    ...
                    rules: [{ required: true, message: 'Please enter your city' }, {max: 100, message: 'Please enter less text for city'}],
                  })(
              ...
              <FormItem className="popup-form-title">
                  {getFieldDecorator('phone_number',{
                    ...
                    rules: [{ required: true, message: 'Please enter your Phone Number' }, {max: 20}],
                  })(
