            ...
            <div className="home-page">
                ...
                :
                    <div className="confirmation-msg">
                        ...
                        <Button className="home-resend-btn" type="primary" onClick={this.handleSubmit.bind()}>Resend</Button>                
                    </div>
                }
                <div className="home-header">
                    ...
                    <a href="./job_category"><Button className="post-job-btn" type="primary" size="large">Post A New Job</Button></a>
                </div>
                    ...
                    <aside className="home-sidebar">
                        <div className="home-sidebar-block">
                            ...
                            {!!Defender.currentUser().avatar_url && !!Defender.currentUser().title ?
                                <Button className="my-profile-btn" href={"/profile/"+Defender.currentUser().id} type="primary">Profile</Button>
                    ...
                    <div className="home-main-holder">
                        {client_openned_jobs === 0 && client_active_jobs === 0 ?
                            <div className="post-new-job-block">
                                ...
                                <Button href="./job_category" className="post-new-job-btn" type="primary" size="large">Post A New Job</Button>
                            </div>
                        :
                        <React.Fragment>
                            <OpennedJobs/>
