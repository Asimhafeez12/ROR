...
class UserExpertiseMobileView extends Component {


 componentWillMount() {
   this.props.fetchUserSkills(window.location.href.split('/')[4]);
   this.props.fetchUserExpertise(window.location.href.split('/')[4]);
 }
...
export default connect(mapStateToProps, mapDispatchToProps)(UserExpertiseMobileView);