	...
	return (
		<div className="signin-holder">
			<div className="login-left-block">
				<img src={signImage} alt="Sign in Banner" />
			</div>
				...
				<div className="login-right-table">
					<div className="login-right-cell">
						<div className="signin-logo-holder">
							<a href="/">
								<img width="250" src={logo} alt="Evolve Machine Learner Logo" />
							</a>
						</div>
						...
						<Form onSubmit={this.handleSubmit} className="login-form">
						  ...
						  <div className="button-holder">
							...
							<p className="register-text">Do not have an account yet ? <a className="register-now-btn" href="/sign_up">Register!</a></p>
						</Form>
					</div>
				</div>
			</div>
