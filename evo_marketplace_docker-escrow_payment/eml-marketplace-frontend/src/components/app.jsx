...
const PrivateRoute = ({ component: Component, ...rest }) => (
	<Route
		{...rest}
		render={props =>
			!!Defender.currentUser() || window.location.href.split('/')[3] === "job_category" || window.location.href.split('/')[3] === "job_creation"  ? (
				<Component {...props} />
			) : (
				<Redirect
					to={{
...
const App = () => (
	<Layout>
		...
		<Layout.Content>
			...
			<PrivateRoute path='/job_category' component={JobCategory} />
			...
			<PrivateRoute path='/job_creation/:job_category' component={JobCreation} />
